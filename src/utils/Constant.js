...
export const SPACING = {
  sw10: DIMENSIONS.WINDOW_WIDTH / 37.5,
  sw12: DIMENSIONS.WINDOW_WIDTH / 32.5,
  sw15: DIMENSIONS.WINDOW_WIDTH / 25,
  sw20: DIMENSIONS.WINDOW_WIDTH / 19,
  sw30: DIMENSIONS.WINDOW_WIDTH / 8,
  sw50: DIMENSIONS.WINDOW_WIDTH / 7,
  sw60: DIMENSIONS.WINDOW_WIDTH / 6,
  sw80: DIMENSIONS.WINDOW_WIDTH / 4,
  sw100: DIMENSIONS.WINDOW_WIDTH / 3,
  sh2: DIMENSIONS.WINDOW_HEIGHT / 250,
  sh4: DIMENSIONS.WINDOW_HEIGHT / 170,
  sh6: DIMENSIONS.WINDOW_HEIGHT / 120,
  sh8: DIMENSIONS.WINDOW_HEIGHT / 80,
  sh10: DIMENSIONS.WINDOW_HEIGHT / 80,
  sh12: DIMENSIONS.WINDOW_HEIGHT / 65,
  sh15: DIMENSIONS.WINDOW_HEIGHT / 54,
  sh20: DIMENSIONS.WINDOW_HEIGHT / 40,
  sh25: DIMENSIONS.WINDOW_HEIGHT / 32,
  sh35: DIMENSIONS.WINDOW_HEIGHT / 25,
  sh45: DIMENSIONS.WINDOW_HEIGHT / 20,
  sh50: DIMENSIONS.WINDOW_HEIGHT / 19,
  sh100: DIMENSIONS.WINDOW_HEIGHT / 15,
  sh110: DIMENSIONS.WINDOW_HEIGHT / 14,
  sh130: DIMENSIONS.WINDOW_HEIGHT / 7,
  sh150: DIMENSIONS.WINDOW_HEIGHT / 4.5,
};

export const WIDTH = {
  w0: DIMENSIONS.WINDOW_WIDTH,
  w7: DIMENSIONS.WINDOW_WIDTH / 60,
  w18: DIMENSIONS.WINDOW_WIDTH / 18,
...
export const HEIGHT = {
  ...
  h17: DIMENSIONS.WINDOW_HEIGHT / 50,
